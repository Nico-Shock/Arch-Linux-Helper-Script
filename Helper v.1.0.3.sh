...
ask_user "Do you you want to install Nvidia open drivers?" install_open_nvidia_driver
...
if $install_cachyos; then
  download_and_install "https://mirror.cachyos.org/cachyos-repo.tar.xz" "cachyos-repo.tar.xz"
  cd cachyos-repo
